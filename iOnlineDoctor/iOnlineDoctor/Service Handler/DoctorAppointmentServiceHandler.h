...
@property (nonatomic, retain) NSString *isFromDocument;
...
@property (nonatomic, retain) NSString *callInterruptionMessage;
...
@property (nonatomic, retain) NSString *isEVisit;

@property (nonatomic, assign) int InterruptionTime;
@property (nonatomic,assign) int  isAlreadyOnCall;
