...
- (instancetype)init
{
    ...
    if ( self )
    {
        ...
        self.circleLayer = ({
            ...
            layer.strokeColor     = [UIColor colorWithRed:66.0/255.0 green:237.0/255. blue:187.0/255. alpha:1.0].CGColor;
        ...
        //66 237 187
        self.colors = @[(__bridge id)[UIColor colorWithRed:66.0/255.0 green:237.0/255. blue:187.0/255. alpha:1.0].CGColor,(__bridge id)[UIColor colorWithRed:66.0/255.0 green:237.0/255. blue:187.0/255. alpha:1.0].CGColor,(__bridge id)[UIColor colorWithRed:66.0/255.0 green:237.0/255. blue:187.0/255. alpha:1.0].CGColor,(__bridge id)[UIColor colorWithRed:66.0/255.0 green:237.0/255. blue:187.0/255. alpha:1.0].CGColor];
...
- (void)startAnimation
{
    ...
    fadeAnimation.fromValue         = (__bridge id)[UIColor colorWithRed:66.0/255.0 green:237.0/255. blue:187.0/255. alpha:1.0].CGColor;
